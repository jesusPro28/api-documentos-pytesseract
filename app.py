...
# Configuración del motor Tesseract OCR (más ligero, sin descarga de modelos extra)
# El archivo packages.txt le indica a Render que instale tesseract-ocr en el servidor
...
def ejecutar_barrera_3(img_gray: np.ndarray, clase_doc: str) -> tuple:
    ...
    # Inferencia con pytesseract (ligero, sin descarga de modelos adicionales)
    ...
    # Pytesseract no devuelve confianza por palabra, usamos 0.85 como estimado estándar
